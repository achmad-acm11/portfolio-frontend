...
export default function Header(props) {
  ...
  return (
    <nav className="navbar navbar-expand-lg position-fixed bottom-0 start-0 w-100 navbar-dark" data-aos="fade-zoom-in" data-aos-easing="ease-in" data-aos-once="true">
