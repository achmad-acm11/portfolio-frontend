...
export default function Hero(props) {
  return (
    <section className="hero-profile text-center px-4" id="hero-profile" data-aos="fade-zoom-in" data-aos-delay="200" data-aos-duration="2000" data-aos-easing="ease-in" data-aos-once="true">
